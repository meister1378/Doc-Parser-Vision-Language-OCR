...
class DataArguments:
    ...
    # optional LMDB training data (OCR-style) support
    train_lmdb_paths: str = field(
        default=None,
        metadata={
            "help": "LMDB paths for training datasets. Multiple paths supported via comma-separated list."
        },
    )
    train_lmdb_prob: str = field(
        default=None,
        metadata={
            "help": "probabilities of LMDB training datasets. Multiple values supported via comma-separated list."
        },
    )
